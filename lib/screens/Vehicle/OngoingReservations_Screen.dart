...
import 'package:taxi_reservation/models/ReservationV.dart';
...
class _OngoingReservationsScreenState extends State<OngoingReservationsScreen> {
  ...
  Future<void> _cancelReservation(String reservationId) async {
    ...
    if (confirm == true) {
      try {
        final docRef = FirebaseFirestore.instance.collection('reservationsV').doc(reservationId);
  ...
  Future<void> _generatePDF(ReservationV reservation) async {
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final reservations = snapshot.data!.docs
              .map((doc) => ReservationV.fromMap(doc.data() as Map<String, dynamic>))
              .toList();
